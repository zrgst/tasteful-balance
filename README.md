...
UID as a 4-byte HEX number. That doe not help much when you want to add this card to
an ARX access-control system. So i made this easy converter too in Rust.
